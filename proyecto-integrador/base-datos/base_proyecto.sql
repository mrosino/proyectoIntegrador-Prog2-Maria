...
-- Tiempo de generación: 28-06-2021 a las 21:05:46
...
(209, 24, NULL, '1623970728129.jpg-image  ', 'Gaturri  ', '2021-06-17', 'Gato tricolor con ojos claros. Macho.  ', '2021-06-17', 1345);
...
INSERT INTO `users` (`id`, `name`, `surname`, `email`, `password`, `profile_pic`, `province`, `gender`, `birthday`, `phone`, `registration_date`, `userUpdate_date`) VALUES
(7, 'Sofia', 'buye', 'adela.buye@gmail.co', '$2a$10$ALfwR6osp4x3Y18y0OqiR.Q.gDK6M86AbO1qnib8.F.UOx6t.rW3O', '1623690971168.jpg-ppe', 'Chubut', 'femenino', '2000-12-03', 1130180066, NULL, '2021-06-15'),
(16, 'Violeta', 'olascoaga', 'viole123@yahoo.com', '$2a$10$nY2WreEc7ScUmJggaVTbbenO6bFBtzthB9vKQ6o0fo02SUKztXSP2', NULL, 'Salta', 'femenino', '2021-05-14', 11736253, NULL, NULL),
(18, 'Mariano', 'biocca', 'mariano.biocca1@gmail.com', '$2a$10$21jtMQzmAuif89m3B9aNXeTEZzASvzNz/VlAAk6BgmOSc6dPcem4e', '1623803834958.jpg-ppe', 'Buenos Aires', 'masculino', '1995-11-02', 114567890, NULL, '2021-06-16'),
(24, 'Justina', 'buye', 'adela.buye@gmail.com', '$2a$10$msCXGcXxnYTwW4oeq8UcGOJORPLJG6/nhopKuimH2aYQdtU6hLt6a', '1623601972211.jpg-ppe', 'CABA', 'masculino', '2021-06-03', 1130180066, '2021-06-07', '2021-06-17'),
(25, 'augusto', 'BUYE', 'abuye@gmail.com', '$2a$10$SMyyBV1O8zrvub6sBKemvegWrHuH4uVYElPwHRen1VHAzWI2Ijj/i', 'pp-1623094194351.jpg', 'CABA', 'masculino', '1963-01-13', 1130180066, '2021-06-07', '2021-06-07'),
(26, 'olivia', 'rozze', 'olirozze@gmail.com', '$2a$10$9RnKn1dYTAi0oNxmzZvkG./DCa/ezqHdAUR6RAZDE1acDMoKInl9y', '1623261319687.png-pp', 'CABA', 'femenino', '2021-06-01', 345235245, '2021-06-09', '2021-06-09'),
(31, 'marilu', 'londres', 'marilulondres@gmail.com', '$2a$10$dUbWBnB1DtQFYrApMgsKMulKRO99de0yeItYwCvd.A503FWkrmHxO', '1623330224249.jpeg-pp', 'CABA', 'femenino', '2020-06-29', 345235246, '2021-06-10', '2021-06-10'),
(32, 'Mateo', 'Casasnovas', 'casasnovasmateo@gmail.com', '$2a$10$AaghvX1b3gpI.XWppU7R8uCS1tcuVftlAZDw4xUcTOx3zusbiR4uS', '1623330405306.jpeg-pp', 'Buenos Aires', 'masculino', '2021-06-01', 67257645, '2021-06-10', '2021-06-10'),
(33, 'mariano', 'lauren', 'marianolauren@gmail.com', '$2a$10$5uc.D5ny1Ndw4UgW.VRX5O8Qzky33JTejUiUKwzAWecAsVqHEtsjy', '1623330541153.jpeg-pp', 'CABA', 'masculino', '2018-06-06', 345235286, '2021-06-10', '2021-06-10'),
(34, 'marianela', 'martinez', 'marianelamarti@gmail.com', '$2a$10$7MIUPsLIWihAbV079vKXGOyuA53ug5S9heLbCOUjxOiuk5keRFKju', '1623330605330.jpeg-pp', 'CABA', 'masculino', '2020-06-09', 345235784, '2021-06-10', '2021-06-10'),
(35, 'gustavo', 'rodriguez', 'gusrodriguez@gmail.com', '$2a$10$12DCl60QruTizoFKh0OYzezc0WdTreUy4W9p3k/zk5fMe92FxuaEy', '1623330652951.jpeg-pp', 'CABA', 'masculino', '2018-02-08', 347585246, '2021-06-10', '2021-06-10'),
(36, 'martin', 'pereyra', 'martinpere@gmail.com', '$2a$10$bzVKIrt4/uKKfgXy31HXn.jfgxyvb0XhgbqzIkVkQdLa79MasefUi', '1623330820003.jpeg-pp', 'CABA', 'masculino', '2017-07-13', 564235246, '2021-06-10', '2021-06-10'),
(37, 'miranda', 'doral', 'miridoral@gmail.com', '$2a$10$8aD5ngfetRLJlKvLqD/IqukQkmrzcWoJzR5heG4ymDKAYnwKTFB0.', '1623330866903.jpeg-pp', 'CABA', 'femenino', '2017-02-08', 345289746, '2021-06-10', '2021-06-10'),
(38, 'milagros', 'sanju', 'milusanju@gmail.com', '$2a$10$dMe.eUCW84FMiVGprhdIS.qSB4Luddj/DXYHcRgeM71sf6a1Y8lJ2', '1623330913808.jpeg-pp', 'CABA', 'femenino', '2017-09-12', 345235057, '2021-06-10', '2021-06-10'),
(39, 'Maria ', 'Rosino', 'mvrosino@hotmail.com', '$2a$10$8Dp27Q3BKIrtooR.TtZuaej6H2M6XkAnx7onMrWlopRUnbsfH9biq', '1623592063107.jpg-pp', 'Buenos Aires', 'femenino', '1998-07-03', 381639879, '2021-06-13', '2021-06-13'),
(40, 'Nicolas', 'bilinkis', 'nico@bilinkis.com', '$2a$10$Ui3nUmg7hV1Ecj3AImzUeuKnTUPouF/nY3Nymo2BuDCJ6nyk8tSrS', '1623639722383.jpg-pp', 'CABA', 'masculino', '1999-08-03', 1130180066, '2021-06-14', '2021-06-14');
